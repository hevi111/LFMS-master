<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="View_all_lost.aspx.cs" Inherits="LFMS.Views.Employee.View_all_items" %>
...
<br />
    ...
    <h2><b> All Lost Items</b></h2> <asp:Label ID="empLabel" runat="server" Font-Size="Large"></asp:Label>
<hr />
...
<br />
 ...
 <asp:GridView ID="AllLostItemsGrid" CssClass="table" runat="server" AutoGenerateColumns="False" 
  BorderColor="#cccccc" BorderWidth="1px" CellPadding="10" ForeColor="Black"  OnRowCommand="SelectLost_RowCommand" OnRowDeleting="RecentLostGrid_RowDeleting1"
  GridLines="None">
