<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="View_dep_items.aspx.cs" Inherits="LFMS.Views.Admin.View_dep_items" %>
...
<hr />
    <asp:Label ID="noLostLabel" runat="server" CssClass="text-danger d-none"  ></asp:Label>
 ...
 <asp:GridView ID="AllLostItemsDepartmentGrid" CssClass="table" runat="server" AutoGenerateColumns="False" 
  ...
  GridLines="None" OnRowDeleting="AllLostItemsDepartmentGrid_RowDeleting">
...
<hr />
    <asp:Label ID="noFoundLabel" runat="server" CssClass="text-danger d-none"  ></asp:Label>
 ...
 <asp:GridView ID="AllFoundItemsDepartmentGrid" CssClass="table" runat="server" AutoGenerateColumns="False" 
  ...
  GridLines="None" OnRowDeleting="AllFoundItemsDepartmentGrid_RowDeleting">
  <AlternatingRowStyle BackColor="#f2f2f2"/>
  <Columns>
    <asp:BoundField DataField="id" HeaderText="id" InsertVisible="False" ReadOnly="True" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol" />
    <asp:BoundField DataField="title" HeaderText="Title" InsertVisible="False" ReadOnly="True" />
