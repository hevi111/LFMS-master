<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="Admin_home.aspx.cs" Inherits="LFMS.Views.Admin.Admin_home" %>
...
<br />
 <asp:GridView ID="RecentLostGrid" runat=server CssClass="table"  AutoGenerateColumns="False" 
  ...
  GridLines="None" OnRowCommand="SelectLost_RowCommand" OnRowDeleting="RecentLostGrid_RowDeleting">
  <AlternatingRowStyle BackColor="#f2f2f2" />
  <Columns>
...
<br />
 <asp:GridView ID="RecentFoundGrid" runat=server CssClass="table"  AutoGenerateColumns="False" 
  BorderColor="#cccccc" BorderWidth="1px" CellPadding="10" ForeColor="Black" 
  GridLines="None" OnRowCommand="SelectFound_RowCommand" OnRowDeleting="RecentFoundGrid_RowDeleting">
  <AlternatingRowStyle BackColor="#f2f2f2" />
